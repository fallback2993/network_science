...
def map_equation_improved(G, partition_map, DEBUG=False):
    ...
    p_a_i, q_out_i, q_out, p_circle_i, p_u, partition_map, community_map = map_equation_essentials(G, partition_map, DEBUG)
    L, index_codelength, module_codelength = compute_minimal_codelength(q_out_i, q_out, p_circle_i, p_u, community_map, num_partitions)
    return L, index_codelength, module_codelength
...
def compute_minimal_codelength(q_out_i, q_out, p_circle_i, p_u, community_map, num_partitions):
